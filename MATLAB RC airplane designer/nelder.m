...
fprintf('speed [km/hr]   drag [N]   span [m]   root [m]   taper   twist [deg]   lift_drag [N]   drag_profile [N]   Cl_required   Cl_achieved   alpha [deg] \n')
for j =1:n+1,
    Z = V(j,1:n);
    Y(j) = feval(Fn,Z);
end
fprintf('_________________________________\n\n')
fprintf('possible new vertexes:\n')
...
% The main while loop has started.
  ...
  if show==1,
    diary nelder_results,diary off;
